...
Script Purpose:
	...
	- Truncates silver bronze tables before loading data.
	- Inserts transformed/clean data from 'bronze' into 'silver' tables
Parameters:
	None. This stored procedure doesn't accept parameters or return
	values.
Usage Example:
